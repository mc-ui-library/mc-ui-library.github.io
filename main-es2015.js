...
let DropdownComponent = class DropdownComponent extends _field_base_component__WEBPACK_IMPORTED_MODULE_2__["FieldBaseComponent"] {
    constructor(er, service) {
        super(er, service);
        this.er = er;
        this.service = service;
...
let ExampleComponent = class ExampleComponent extends _index__WEBPACK_IMPORTED_MODULE_2__["AppBaseComponent"] {
    constructor(er, service, homeService) {
        ...
        this.listBasicTagsData = this.data.map((d, i) => {
            const item = {
                id: d.id,
                name: d.name,
                theme: ['tag']
