...
/* harmony import */ var _utils_viz_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../utils/viz-utils */ "./projects/mc-ui/src/lib/utils/viz-utils.ts");
/* harmony import */ var _shared_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../shared.service */ "./projects/mc-ui/src/lib/shared.service.ts");
...
class VisualizerComponent extends _base_component__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"] {
    ...
    rednerGrid(config) {
        this.removeContent();
        const gridCmp = this.sharedService.addComponent(_grid_grid_component__WEBPACK_IMPORTED_MODULE_3__["GridComponent"], this.el);
        const instance = gridCmp.instance;
        const data = Object(_utils_viz_utils__WEBPACK_IMPORTED_MODULE_4__["convertVizToGridData"])(config.data);
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](VisualizerComponent, [{
    ...
    }], function () { return [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"] }, { type: _shared_service__WEBPACK_IMPORTED_MODULE_5__["SharedService"] }]; }, { data: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"]
        }], action: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"]
        }] }); })();
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](McUiModule, { declarations: [_components__WEBPACK_IMPORTED_MODULE_4__["ListComponent"],
        ...
        _components__WEBPACK_IMPORTED_MODULE_4__["TextComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], ngx_perfect_scrollbar__WEBPACK_IMPORTED_MODULE_5__["PerfectScrollbarModule"]], exports: [_components__WEBPACK_IMPORTED_MODULE_4__["ListComponent"],
        _components__WEBPACK_IMPORTED_MODULE_4__["IconComponent"],
        _components__WEBPACK_IMPORTED_MODULE_4__["ListItemComponent"],
        _components__WEBPACK_IMPORTED_MODULE_4__["MaskComponent"],
        _components__WEBPACK_IMPORTED_MODULE_4__["DrawerComponent"],
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VizScaleType", function() { return VizScaleType; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "simpleFormatDate", function() { return simpleFormatDate; });
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");

function simpleFormatDate(date, format = 'yyyy/MM/dd', locale = 'en-US') {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "convertVizToGridData", function() { return convertVizToGridData; });
/* harmony import */ var _shared_models__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../shared.models */ "./projects/mc-ui/src/lib/shared.models.ts");
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! d3 */ "./node_modules/d3/index.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils */ "./projects/mc-ui/src/lib/utils/utils.ts");
...
function renderChartContainer(el, vizSize, themeClass = []) {
    // apply margin
    ...
    return svg
        .append('g')
        .attr('transform', `translate(${vizSize.margin.left},${vizSize.margin.top})`);
}
function getScale(type, domain, range, padding = null, paddingInner = null, paddingOuter = null) {
    let scale;
    switch (type) {
...
function getAxis(location, scale, ticks = null, tickFormat = null) {
    let axis;
    switch (location) {
...
function renderAxis(svg, location, axis, vizSize, themeClass = []) {
...
function renderGrid(svg, direction, axis, vizSize, themeClass = []) {
    svg = svg.append('g').attr('class', themeClass.join(' '));
    let tickSize;
    switch (direction) {
        case 'x':
...
function getAxisSize(el, svg, location, axis, vizSize, themeClass = []) {
    renderAxis(svg, location, axis, vizSize, themeClass);
    return getSVGSize(el, '.' + themeClass[0]);
}
function convertVizToGridData(data, seriesColumnName = '') {
    const rows = [];
    const columns = [];
    if (seriesColumnName) {
        columns.push({
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ChartTypes", function() { return _lib_shared_models__WEBPACK_IMPORTED_MODULE_2__["ChartTypes"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "VizScaleType", function() { return _lib_shared_models__WEBPACK_IMPORTED_MODULE_2__["VizScaleType"]; });
...
const _c0 = function () { return { name: "company", value: "a" }; };
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵInheritDefinitionFeature"]], decls: 3, vars: 20, consts: [[3, "config", "action"], [3, "config", "data", "action"], [3, "config", "data"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("action", function AppComponent_Template_mc_visualizer_action_1_listener($event) { return ctx.onCompanyVizAction($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    ...
    } }, directives: [_projects_mc_ui_src_lib_components_form_fields_text_text_component__WEBPACK_IMPORTED_MODULE_4__["TextComponent"], _projects_mc_ui_src_lib_components_visualizer_visualizer_component__WEBPACK_IMPORTED_MODULE_5__["VisualizerComponent"]], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2FwcC5jb21wb25lbnQuc2NzcyJ9 */"] });
...
/* harmony import */ var _models_manual__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./models-manual */ "./src/app/models-manual.ts");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
/* harmony import */ var projects_mc_ui_src_lib_utils_date_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! projects/mc-ui/src/lib/utils/date-utils */ "./projects/mc-ui/src/lib/utils/date-utils.ts");
...
class AppService {
    ...
    getCompanies(keyword = '') {
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]()
            .set(_models_manual__WEBPACK_IMPORTED_MODULE_2__["AlphaVantageAPIParamKey"].function, _models_manual__WEBPACK_IMPORTED_MODULE_2__["AlphaVantageAPIFunction"].SYMBOL_SEARCH)
            .set(_models_manual__WEBPACK_IMPORTED_MODULE_2__["AlphaVantageAPIParamKey"].keywords, keyword)
            .set(_models_manual__WEBPACK_IMPORTED_MODULE_2__["AlphaVantageAPIParamKey"].apikey, _models_manual__WEBPACK_IMPORTED_MODULE_2__["AlphaVantageAPI"].key);
        return this.http
            .get(_models_manual__WEBPACK_IMPORTED_MODULE_2__["AlphaVantageAPI"].url, { params })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((data) => this.normalizeComponies(data)));
    }
    normalizeComponies(data) {
        const vizDataMap = new Map();
    ...
    getTimeSeries(symbol, fn = _models_manual__WEBPACK_IMPORTED_MODULE_2__["AlphaVantageAPIFunction"].TIME_SERIES_DAILY, outputsize = _models_manual__WEBPACK_IMPORTED_MODULE_2__["AlphaVantageAPIOutputSize"].compact) {
        const params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]()
            .set(_models_manual__WEBPACK_IMPORTED_MODULE_2__["AlphaVantageAPIParamKey"].function, fn)
            .set(_models_manual__WEBPACK_IMPORTED_MODULE_2__["AlphaVantageAPIParamKey"].symbol, symbol)
            .set(_models_manual__WEBPACK_IMPORTED_MODULE_2__["AlphaVantageAPIParamKey"].outputsize, outputsize)
            .set(_models_manual__WEBPACK_IMPORTED_MODULE_2__["AlphaVantageAPIParamKey"].apikey, _models_manual__WEBPACK_IMPORTED_MODULE_2__["AlphaVantageAPI"].key);
        return this.http
            .get(_models_manual__WEBPACK_IMPORTED_MODULE_2__["AlphaVantageAPI"].url, { params })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((data) => this.normalizeTimeseries(data, fn)));
    }
    normalizeTimeseries(data, fn) {
        const vizDataMap = new Map();
        switch (fn) {
            case _models_manual__WEBPACK_IMPORTED_MODULE_2__["AlphaVantageAPIFunction"].TIME_SERIES_DAILY:
                const d = data[_models_manual__WEBPACK_IMPORTED_MODULE_2__["TimeSeriesType"].TIME_SERIES_DAILY];
                Object.keys(d).forEach(date => {
                    this.addVizDataValues('date', Object(projects_mc_ui_src_lib_utils_date_utils__WEBPACK_IMPORTED_MODULE_4__["simpleFormatDate"])(date), vizDataMap);
                    const keyVal = d[date];
    ...
    addVizDataValues(key, value, vizDataMap) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AlphaVantageAPI", function() { return AlphaVantageAPI; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AlphaVantageAPIParamKey", function() { return AlphaVantageAPIParamKey; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AlphaVantageAPIOutputSize", function() { return AlphaVantageAPIOutputSize; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AlphaVantageAPIFunction", function() { return AlphaVantageAPIFunction; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TimeSeriesType", function() { return TimeSeriesType; });
var AlphaVantageAPI;
