...
class DomUtil {
     ...
     * @return {?}
     */
    findParent(dom, selector, depth = 10) {
        /** @type {?} */
        let cls = '';
        /** @type {?} */
        let resultDom;
...
class DataUtil {
     ...
     * @return {?}
     */
    search(items, keyword, field = 'name') {
        if (keyword) {
            /** @type {?} */
...
class Util {
     ...
     * @return {?}
     */
    debounce(callback, wait, scope = this) {
        /** @type {?} */
        let timeout;
        return (/**
         * @param {...?} args
        ...
        (...args) => {
             ...
             * @return {?}
             */
            () => callback.apply(scope, args)), wait);
        });
    }
    /**
     * @param {?} callback
     ...
     * @return {?}
     */
    throttle(callback, wait, scope = this) {
        /** @type {?} */
        let timeout;
        return (/**
         * @param {...?} args
...
class MCUIService {
     ...
     * @param {?} hc
     */
    constructor(_resolver, injector, appRef, hc) {
...
class BaseComponent {
    ...
    applyThemeClass() {
        if (this.theme) {
            ...
            this.el.classList.add(...themes.map((/**
             * @param {?} d
             * @return {?}
             */
            d => compName + '-' + d)));
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class InputComponent extends FieldBaseComponent {
    /**
     * @param {?} er
     * @param {?} service
     */
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class TextareaComponent extends FieldBaseComponent {
    /**
     * @param {?} er
     * @param {?} service
     */
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class FieldComponent extends FieldBaseComponent {
    /**
     * @param {?} er
     * @param {?} service
     */
...
class FormComponent extends BaseComponent {
    ...
    applyReadonly() {
         ...
         * @return {?}
         */
        () => this.inputCmps.forEach((/**
         * @param {?} cmp
         * @return {?}
         */
        cmp => cmp.readonly = this._readonly))));
    }
    /**
     * @return {?}
     */
...
/** @nocollapse */
ScrollComponent.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"] },
    { type: MCUIService }
];
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class ScrollAsyncComponent extends BaseComponent {
    /**
     * @param {?} _el
     * @param {?} _service
     */
    ...
    set additionalData(value) {
        if (value) {
            const { action, rows, start, rowCount } = value;
            /** @type {?} */
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class ListBasicComponent extends BaseComponent {
    /**
     * @param {?} _el
     * @param {?} _service
     */
    ...
    set selectedItems(value) {
        if (value) {
             ...
             * @return {?}
             */
            d => this.selectedItemsMap.set('' + d[this.idField], d)));
        }
    }
    /**
     * @return {?}
...
/** @nocollapse */
ListBasicComponent.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"] },
    { type: MCUIService }
];
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class ListComponent extends ScrollAsyncComponent {
    /**
     * @param {?} _el
     * @param {?} _service
     */
    ...
    show() {
        ...
        () => {
            ...
            () => {
                 ...
                 * @return {?}
                 */
                () => drawerEl.classList.remove('drawer-anim')), 300);
            }), 100);
        }));
    }
    /**
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class MessageBarComponent extends BaseComponent {
    /**
     * @param {?} er
     * @param {?} service
     */
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class GridHeaderComponent extends BaseComponent {
    /**
     * @param {?} _el
     * @param {?} _service
     */
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class GridBodyComponent extends BaseComponent {
    /**
     * @param {?} _el
     * @param {?} _service
     */
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class MaskComponent extends BaseComponent {
    /**
     * @param {?} er
     * @param {?} service
     */
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class GridComponent extends ScrollAsyncComponent {
    /**
     * @param {?} _el
     * @param {?} _service
     */
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class PopupListComponent extends PopupComponent {
    /**
     * @param {?} er
     * @param {?} service
     */
...
/** @nocollapse */
PopupListComponent.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"] },
    { type: MCUIService }
];
...
let ButtonComponent = class ButtonComponent extends _base_component__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"] {
    constructor(er, service) {
        super(er, service);
        this.er = er;
        this.service = service;
...
let DrawerComponent = class DrawerComponent extends _base_component__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"] {
    constructor(er, service) {
        super(er, service);
        this.er = er;
        this.service = service;
        ...
        this.tpl = null;
        this.mask = true;
        this.hided = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    set visible(value) {
        this._visible = value;
        if (value) {
...
class FieldBaseComponent extends _base_component__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"] {
    constructor(er, service) {
        super(er, service);
        this.er = er;
        this.service = service;
...
let FieldComponent = class FieldComponent extends _field_base_component__WEBPACK_IMPORTED_MODULE_4__["FieldBaseComponent"] {
    constructor(er, service) {
        super(er, service);
        this.er = er;
        this.service = service;
...
let InputComponent = class InputComponent extends _field_base_component__WEBPACK_IMPORTED_MODULE_2__["FieldBaseComponent"] {
    constructor(er, service) {
        super(er, service);
        this.er = er;
        this.service = service;
...
let TextareaComponent = class TextareaComponent extends _field_base_component__WEBPACK_IMPORTED_MODULE_2__["FieldBaseComponent"] {
    constructor(er, service) {
        super(er, service);
        this.er = er;
        this.service = service;
...
let FormComponent = class FormComponent extends _base_component__WEBPACK_IMPORTED_MODULE_3__["BaseComponent"] {
    constructor(er, service) {
        super(er, service);
        this.er = er;
        this.service = service;
...
let GridBodyComponent = class GridBodyComponent extends _base_component__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"] {
    constructor(_el, _service) {
        super(_el, _service);
        this._el = _el;
        this._service = _service;
...
let GridHeaderComponent = class GridHeaderComponent extends _base_component__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"] {
    constructor(_el, _service) {
        super(_el, _service);
        this._el = _el;
        this._service = _service;
...
let IconComponent = class IconComponent extends _base_component__WEBPACK_IMPORTED_MODULE_3__["BaseComponent"] {
    constructor(_el, _service) {
        super(_el, _service);
        this._el = _el;
        this._service = _service;
...
let ListBasicComponent = class ListBasicComponent extends _base_component__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"] {
    constructor(_el, _service) {
        super(_el, _service);
        this._el = _el;
        this._service = _service;
...
let ListItemComponent = class ListItemComponent extends _base_component__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"] {
    constructor(er, service) {
        super(er, service);
        this.er = er;
        this.service = service;
...
let ListComponent = class ListComponent extends _scroll_scroll_async_component__WEBPACK_IMPORTED_MODULE_2__["ScrollAsyncComponent"] {
    constructor(_el, _service) {
        super(_el, _service);
        this._el = _el;
        this._service = _service;
...
let LoaderComponent = class LoaderComponent extends _base_component__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"] {
    constructor(er, service) {
        super(er, service);
        this.er = er;
        this.service = service;
...
let MaskComponent = class MaskComponent extends _base_component__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"] {
    constructor(er, service) {
        super(er, service);
        this.er = er;
        this.service = service;
...
let MessageBarComponent = class MessageBarComponent extends _base_component__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"] {
    constructor(er, service) {
        super(er, service);
        this.er = er;
        this.service = service;
...
let PopupListComponent = class PopupListComponent extends _popup_component__WEBPACK_IMPORTED_MODULE_3__["PopupComponent"] {
    constructor(er, service) {
        super(er, service);
        this.er = er;
        this.service = service;
        ...
        this.startFrom = 'start';
        this.valueChange = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.needData = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.filterDebounce = this.util.debounce(this.filter, 300, this);
    }
    set selectedItems(value) {
        if (value) {
...
let PopupComponent = class PopupComponent extends _base_component__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"] {
    constructor(er, service) {
        super(er, service);
        this.er = er;
        this.service = service;
...
class ScrollAsyncComponent extends _base_component__WEBPACK_IMPORTED_MODULE_1__["BaseComponent"] {
    constructor(_el, _service) {
        super(_el, _service);
        this._el = _el;
        this._service = _service;
        ...
        this.rowHeight = 30;
        // there is no data, then it triggers "needData" event.
        this.needData = new _angular_core__WEBPACK_IMPORTED_MODULE_2__["EventEmitter"]();
    }
    set data(value) {
        if (value) {
            let data;
...
let ScrollComponent = class ScrollComponent extends _base_component__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"] {
    constructor(_el, _service) {
        super(_el, _service);
        this._el = _el;
        this._service = _service;
        ...
        this.rowHeight = 30;
        this.isLoading = false;
        this.updatePage = new _angular_core__WEBPACK_IMPORTED_MODULE_3__["EventEmitter"]();
    }
    set rowCount(value) {
        if (!this.util.isEmpty(value)) {
            this._rowCount = value;
...
let MCUIModule = class MCUIModule {
};
 ...
 * App Level shared services e.g) Dynamic Components or EventEmitters for sending message between UI Page Componensts, window resize etc.
 */
let MCUIService = class MCUIService {
    constructor(_resolver, injector, appRef, hc) {
        this._resolver = _resolver;
        this.injector = injector;
        this.appRef = appRef;
...
class AppBaseService {
    ...
    http(type, url, params, options) {
        ...
        return http.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])((data) => {
...
let AuthService = class AuthService extends _app_base_service__WEBPACK_IMPORTED_MODULE_3__["AppBaseService"] {
    constructor(service) {
        super(service);
        this.service = service;
    }
...
let SigninComponent = class SigninComponent extends _index__WEBPACK_IMPORTED_MODULE_2__["AppBaseComponent"] {
    constructor(er, service, authService, router) {
        super(er, service);
        this.er = er;
        this.service = service;
...
let ExampleRoutingModule = class ExampleRoutingModule {
};
...
let ExampleComponent = class ExampleComponent extends _index__WEBPACK_IMPORTED_MODULE_2__["AppBaseComponent"] {
    constructor(er, service) {
        super(er, service);
        this.er = er;
        this.service = service;
...
let GridExampleComponent = class GridExampleComponent extends src_app_app_base_component__WEBPACK_IMPORTED_MODULE_2__["AppBaseComponent"] {
    constructor(er, service, homeService) {
        super(er, service);
        this.er = er;
        this.service = service;
...
let ListExampleComponent = class ListExampleComponent extends src_app_app_base_component__WEBPACK_IMPORTED_MODULE_2__["AppBaseComponent"] {
    constructor(er, service, homeService) {
        super(er, service);
        this.er = er;
        this.service = service;
...
ListExampleComponent.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewContainerRef"] },
    { type: mc_ui_angular__WEBPACK_IMPORTED_MODULE_3__["MCUIService"] },
    { type: _home_service__WEBPACK_IMPORTED_MODULE_4__["HomeService"] }
];
...
let HomeLeftMenuComponent = class HomeLeftMenuComponent extends _index__WEBPACK_IMPORTED_MODULE_2__["AppBaseComponent"] {
    constructor(er, service, homeService, router) {
        super(er, service);
        this.er = er;
        this.service = service;
        this.homeService = homeService;
        ...
        this.menuData = this.homeService.getMenuList();
        this.minimized = false;
        this.hover = false;
        this.minimize = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
...
HomeLeftMenuComponent.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewContainerRef"] },
    { type: mc_ui_angular__WEBPACK_IMPORTED_MODULE_4__["MCUIService"] },
...
let HomeComponent = class HomeComponent extends _index__WEBPACK_IMPORTED_MODULE_2__["AppBaseComponent"] {
    constructor(er, service, router) {
        super(er, service);
        this.er = er;
        this.service = service;
        this.router = router;
        this.leftMenuMinimized = false;
    }
...
let HomeService = class HomeService extends _app_base_service__WEBPACK_IMPORTED_MODULE_3__["AppBaseService"] {
    constructor(service) {
        super(service);
        this.service = service;
    }
...
class Url {
     ...
     */
    getUrl(id, params = [], isMockData = false) {
        let val = URLS[id];
        if (params.length > 0) {
            params.map((u, i) => {
                val = val.replace(`{${i}}`, u);
